...
*FOR THE VARIABLE hsdrunk
	...
	*Save bar chart in "Graphs" folder (using relative path)
	...
	tabulate hsdrunk, gen(hsdrunk_)
	
	graph bar hsdrunk_1 hsdrunk_2 , ///
		ytitle(Percent Frequency) ///
		legend(label(1 0) label(2 1)) ///
		ti("Percent Frequency Distribution of hsdrunk") ///
		saving(../Graphs/hsdrunk-drunk.gph, replace)
...
*FOR THE VARIABLE free
	...
	*Save bar chart in "Graphs" folder (using relative path)
	...
	tabulate free, gen(free_)
	
	graph bar free_1 free_2 , ///
		ytitle(Percent Frequency) ///
		legend(label(1 0) label(2 1)) ///
		ti("Percent Frequency Distribution of free") ///
		saving(../Graphs/free-dist.gph, replace)
...
*FOR THE VARIABLE volfree
	...
	*Save bar chart in "Graphs" folder (using relative path)
	...
	tabulate volfree, gen(volfree_)
	
	graph bar volfree_1 volfree_2 , ///
		ytitle(Percent Frequency) ///
		legend(label(1 0) label(2 1)) ///
		ti("Percent Frequency Distribution of volfree") ///
		saving(../Graphs/volfree-dist.gph, replace)
...
*FOR THE VARIABLE housing
	...
	*Save bar chart in "Graphs" folder (using relative path)
	...
	tabulate housing, gen(housing_)
	
	graph bar housing_1 housing_2 housing_3 housing_4, ///
		legend(label(1 1) label(2 2) label(3 3) label(4 4)) ///
		ytitle(Percent Frequency) ///
		ti("Percent Frequency Distribution of housing") ///
		saving(../Graphs/housing-dist.gph, replace)
